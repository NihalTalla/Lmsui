...
import { Bell, Search, Settings, LogOut, Code2, Home, BookOpen, FileCode, MessageSquare, Award, Users, BarChart3, Calendar, User } from 'lucide-react';
        ...
        <aside className="w-64 min-h-[calc(100vh-64px)] bg-white border-r border-neutral-200 flex flex-col">
          ...
          <div className="p-4 border-t border-neutral-200 space-y-2">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-neutral-700 hover:bg-neutral-100 transition-all duration-200 hover:shadow-sm"
            >
